...
```sql
CREATE TABLE cars
USING com.databricks.spark.csv2
...
val df = sqlContext.load(
    "com.databricks.spark.csv2",
    Map("path" -> "cars.csv", "header" -> "true", "inferSchema" -> "true"))
val selectedData = df.select("year", "model")
selectedData.save("newcars.csv", "com.databricks.spark.csv2")
```
...
DataFrame df = sqlContext.load("com.databricks.spark.csv2", options);
df.select("year", "model").save("newcars.csv", "com.databricks.spark.csv2");
```
...
DataFrame df = sqlContext.load("com.databricks.spark.csv2", customSchema, options);
df.select("year", "model").save("newcars.csv", "com.databricks.spark.csv2");
```
...
df.select("year", "model").save("com.databricks.spark.csv2", SaveMode.Overwrite,
                                saveOptions);
```
...
df = sqlContext.read.format('com.databricks.spark.csv2').options(header='true', inferschema='true').load('cars.csv')
df.select('year', 'model').write.format('com.databricks.spark.csv2').save('newcars.csv')
```
...
df = sqlContext.read.format('com.databricks.spark.csv2').options(header='true', inferschema='true').load('cars.csv')
df.select('year', 'model').write.format('com.databricks.spark.csv2').options(codec="org.apache.hadoop.io.compress.GzipCodec").save('newcars.csv')
```
...
df = sqlContext.load(source="com.databricks.spark.csv2", header = 'true', inferSchema = 'true', path = 'cars.csv')
df.select('year', 'model').save('newcars.csv', 'com.databricks.spark.csv2')
```
...
df = sqlContext.load(source="com.databricks.spark.csv2", header = 'true', schema = customSchema, path = 'cars.csv')
df.select('year', 'model').save('newcars.csv', 'com.databricks.spark.csv2')
```
...
df = sqlContext.load(source="com.databricks.spark.csv2", header = 'true', inferSchema = 'true', path = 'cars.csv')
df.select('year', 'model').save('newcars.csv', 'com.databricks.spark.csv2', codec="org.apache.hadoop.io.compress.GzipCodec")
```
...
df <- read.df(sqlContext, "cars.csv", source = "com.databricks.spark.csv2", inferSchema = "true")

write.df(df, "newcars.csv", "com.databricks.spark.csv2", "overwrite")
```
...
df <- read.df(sqlContext, "cars.csv", source = "com.databricks.spark.csv2", schema = customSchema)
...
write.df(df, "newcars.csv", "com.databricks.spark.csv2", "overwrite", codec="org.apache.hadoop.io.compress.GzipCodec")
```
